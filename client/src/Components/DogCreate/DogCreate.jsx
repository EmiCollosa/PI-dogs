...
export default function CreateDog () {
    ...
    return(
        ...
        <div className={style.titulo}>
            ...
            <h3>NAME:</h3>
            <input required className="numInput" type='text' value={input.name} name="name"  onChange={e => handleChange(e)} />

        </div>

        <div className = {style.items}>
            <h3 >MIN HEIGHT:</h3>
            <input min='0'  className="numInput" type='number' value={input.height_min} name='height_min' onChange = { e => handleChange(e)}  />
        </div>

        <div className = {style.items}>
            <h3 >MAX HEIGHT:</h3>
            <input  min='0' className="numInput" type='number' value={input.height_max} name='height_max' onChange = { e => handleChange(e)}  />
        </div>

        <div className = {style.items}>
        <h3 >MIN WEIGHT: </h3>
        <input  min='0' className="numInput" type='number' value={input.weight_min} name="weight_min" onChange={e => handleChange(e)} />
        </div>

        <div className = {style.items}>
        <h3 >MAX WEIGHT: </h3>
        <input min='0' className="numInput" type='number' value={input.weight_max} name="weight_max" onChange={e => handleChange(e)} />
        </div>

       
        <div className = {style.items}>
            <h3>LIFE SPAN:</h3>
            <input min='0' className="numInput" type='number' value={input.lifeTime} name="lifeTime" onChange={e => handleChange(e)} />
        </div>
        <div>
